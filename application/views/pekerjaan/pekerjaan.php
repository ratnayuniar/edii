<script>
    ...
    function formTambah(){
        $.ajax({
            url: '<?= base_url('formTambahPekerjaan'); ?>', // URL of the route
            type: 'GET',
    ...
    function simpanPekerjaan(){
        ...
        $.ajax({
            url: '<?= base_url('simpanPekerjaan'); ?>', // URL of the route
            type: 'POST',
            data: data,
            success: function(msg) {
                // Update the HTML with the view returned by the server
        ...
        <div class="card-body">
            ...
            <table class="table table-striped table-bordered">
                <thead>
                    ...
                    <th class="table-primary" scope="col">Nama Perusahaan</th>
                    <th class="table-primary" scope="col">Posisi Terakhir</th>
                    <th class="table-primary" scope="col">Pendapatan Terakhir</th>
